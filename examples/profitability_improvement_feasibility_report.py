...
- 与当前 ROA/价格低波/120日收益/对数成交额的秩相关中位数：
  {correlations['current_roa']:.3f} / {correlations['vol60']:.3f} /
  {correlations['ret120']:.3f} / {correlations['log_adv']:.3f}。
- 最新 ROA 改善 P1/中位/P99：{distribution['p01']:.2%} /
  {distribution['median']:.2%} / {distribution['p99']:.2%}。
- 公告越界/重复/无效值：{result['visibility_violations']} /
  {result['duplicate_rows']} / {result['invalid_rows']}。
